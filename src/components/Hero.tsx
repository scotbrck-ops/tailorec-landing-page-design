    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 !shadow-none !rounded-none !border-transparent !border-0 !shadow-none !text-black !block !bg-transparent !shadow-none">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center !shadow-[0_2px_4px_0_rgba(0,0,0,0.15)] !shadow-none">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight lg:!text-6xl !border-0 !shadow-none !border-transparent !opacity-0 !bg-transparent !shadow-none">
