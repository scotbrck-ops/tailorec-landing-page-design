...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 !shadow-none !rounded-none !border-transparent !border-0 !shadow-none !text-black !block !bg-transparent !shadow-none">
      {/* Animated Background */}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center !shadow-[0_2px_4px_0_rgba(0,0,0,0.15)] !shadow-none !bg-transparent">
        {/* Logo */}
        <motion.div
          ...
          <Image
            src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/4d236096-5620-493b-a6ce-6c97a6b3c941/visual-edit-uploads/1761565140140-qvstkeuw60a.png"
            alt="Tailorec"
            width={500}
            height={120}
            className="max-w-md !w-[512px] !h-full sm:!max-w-lg !block !opacity-100 !bg-transparent !shadow-[0_32px_48px_-8px_rgba(0,0,0,0.3),0_16px_24px_-8px_rgba(0,0,0,0.2)] !shadow-[0_2px_4px_0_rgba(0,0,0,0.15)] !mx-[151px] !text-center !text-black !text-xl !shadow-none"
            priority />
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight !border-0 !shadow-none !border-transparent !opacity-0 !shadow-none !opacity-100 !opacity-100 lg:!text-6xl lg:!text-black !block !bg-[#ead9fe]">
